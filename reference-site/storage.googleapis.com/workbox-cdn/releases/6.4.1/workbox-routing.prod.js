this.workbox = this.workbox || {}, this.workbox.routing = function(t, e) {
    ...
    class i {
        constructor() {
            this.ut = new Map, this.ft = new Map
        }
        get routes() {
            return this.ut
        }
        ...
        handleRequest({
            ...
            let o = i && i.handler;
            const u = t.method;
            if (!o && this.ft.has(u) && (o = this.ft.get(u)), !o) return;
            let c;
            try {
                c = o.handle({
                    url: s,
            ...
            const a = i && i.catchHandler;
            return c instanceof Promise && (this.lt || a) && (c = c.catch((async r => {
                if (a) try {
                ...
                if (this.lt) return this.lt.handle({
                    url: s,
                    request: t,
                    event: e
                });
        ...
        findMatchingRoute({
            ...
            for (const i of n) {
                ...
                if (o) return n = o, (Array.isArray(n) && 0 === n.length || o.constructor === Object && 0 === Object.keys(o).length || "boolean" == typeof o) && (n = void 0), {
                    route: i,
                    params: n
                }
            }
        ...
        registerRoute(t) {
            this.ut.has(t.method) || this.ut.set(t.method, []), this.ut.get(t.method).push(t)
        }
        unregisterRoute(t) {
            if (!this.ut.has(t.method)) throw new e.WorkboxError("unregister-route-but-not-found-with-method", {
                method: t.method
            });
            const s = this.ut.get(t.method).indexOf(t);
            if (!(s > -1)) throw new e.WorkboxError("unregister-route-route-not-registered");
            this.ut.get(t.method).splice(s, 1)
        }
    }
    let o;
    const u = () => (o || (o = new i, o.addFetchListener(), o.addCacheListener()), o);
    return t.NavigationRoute = class extends r {
        constructor(t, {
            allowlist: e = [/./],
            denylist: s = []
        } = {}) {
            super((t => this.dt(t)), t), this.wt = e, this.gt = s
        }
        dt({
            url: t,
            request: e
            ...
            return !!this.wt.some((t => t.test(s)))
        }
    }, t.RegExpRoute = n, t.Route = r, t.Router = i, t.registerRoute = function(t, s, i) {
        let o;
        if ("string" == typeof t) {
        ...
        } else if (t instanceof RegExp) o = new n(t, s, i);
        else if ("function" == typeof t) o = new r(t, s, i);
        else {
