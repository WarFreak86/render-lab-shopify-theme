    ...
    self.workbox = new class {
        constructor() {
            return this.v = {}, this.Pt = {
                ...
                modulePathCb: null
            }, this.$t = this.Pt.debug ? "dev" : "prod", this.Ct = !1, new Proxy(this, {
                get(e, s) {
                    if (e[s]) return e[s];
                    const o = t[s];
        ...
        setConfig(t = {}) {
            if (this.Ct) throw new Error("Config must be set before accessing workbox.* modules");
            Object.assign(this.Pt, t), this.$t = this.Pt.debug ? "dev" : "prod"
        }
        loadModule(t) {
            const e = this.jt(t);
            try {
                importScripts(e), this.Ct = !0
            } catch (s) {
        ...
        jt(t) {
            ...
            let e = ["https://storage.googleapis.com/workbox-cdn/releases/6.4.1"];
            const s = `${t}.${this.$t}.js`,
