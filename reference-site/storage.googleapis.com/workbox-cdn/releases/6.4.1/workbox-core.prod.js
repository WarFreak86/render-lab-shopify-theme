this.workbox = this.workbox || {}, this.workbox.core = function(t) {
    ...
    const o = {
        ...
        s = t => [o.prefix, t, o.suffix].filter((t => t && t.length > 0)).join("-"),
        i = {
            updateDetails: t => {
                (t => {
    ...
    var g = Object.freeze({
        ...
        resultingClientExists: async function(t) {
            ...
            for (; performance.now() - o < 2e3 && (e = await self.clients.matchAll({
                    type: "window"
                }), r = e.find((e => t ? e.id === t : !n.has(e.id))), !r);) await l(100);
            return r
        },
        timeout: l,
    ...
    return t._private = g, t.cacheNames = w, t.clientsClaim = function() {
