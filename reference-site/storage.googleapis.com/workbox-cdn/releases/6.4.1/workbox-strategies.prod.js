this.workbox = this.workbox || {}, this.workbox.strategies = function(t, e, s, r, n, i, a, o, c) {
    "use strict";
    try {
    ...
    class l {
        constructor(t, e) {
            this.yt = {}, Object.assign(this, e), this.event = e.event, this.ot = t, this.vt = new n.Deferred, this.qt = [], this.bt = [...t.plugins], this.Et = new Map;
        ...
        async fetch(t) {
            ...
            try {
                ...
                if (t instanceof Error) throw new e.WorkboxError("plugin-error-request-will-fetch", {
            ...
            try {
                let t;
                t = await fetch(r, "navigate" === r.mode ? void 0 : this.ot.fetchOptions);
        ...
        async cacheMatch(t) {
            ...
            const {
                cacheName: r,
                matchOptions: n
            } = this.ot, i = await this.getCacheKey(e, "read"), a = Object.assign(Object.assign({}, n), {
                cacheName: r
            });
        ...
        async cachePut(t, s) {
            ...
            if (!s) throw new e.WorkboxError("cache-put-with-no-response", {
            ...
            const {
                cacheName: w,
                matchOptions: u
            } = this.ot, f = await self.caches.open(w), d = this.hasCallback("cacheDidUpdate"), p = d ? await r.cacheMatchIgnoreParams(f, o.clone(), ["__WB_REVISION__"], u) : null;
            try {
                await f.put(o, d ? l.clone() : l)
            } catch (t) {
                if (t instanceof Error) throw "QuotaExceededError" === t.name && await i.executeQuotaErrorCallbacks(), t
            }
        ...
        async getCacheKey(t, e) {
            ...
            if (!this.yt[s]) {
                let r = t;
                for (const t of this.iterateCallbacks("cacheKeyWillBeUsed")) r = h(await t({
                    mode: e,
                    request: r,
                    event: this.event,
                    params: this.params
    ...
    class w {
        constructor(t = {}) {
            this.cacheName = s.cacheNames.getRuntimeName(t.cacheName), this.plugins = t.plugins || [], this.fetchOptions = t.fetchOptions, this.matchOptions = t.matchOptions
        }
        handle(t) {
        ...
        async kt(t, s, r) {
            ...
            let n = void 0;
            try {
                if (n = await this._handle(s, t), !n || "error" === n.type) throw new e.WorkboxError("no-response", {
                    url: s.url
                })
            } catch (e) {
            ...
            for (const e of t.iterateCallbacks("handlerWillRespond")) n = await e({
                event: r,
                request: s,
                response: n
            });
    ...
    return t.CacheFirst = class extends w {
        ...
        constructor(t = {}) {
            super(t), this.plugins.some((t => "cacheWillUpdate" in t)) || this.plugins.unshift(u), this.Rt = t.networkTimeoutSeconds || 0
        }
        async _handle(t, s) {
            const r = [],
                n = [];
            ...
            n.push(a);
            const o = await s.waitUntil((async () => await s.waitUntil(Promise.race(n)) || await a)());
            if (!o) throw new e.WorkboxError("no-response", {
                url: t.url
            });
            return o
        }
        ...
        async Ot({
            ...
            return t && clearTimeout(t), !n && i || (i = await r.cacheMatch(e)), i
        }
        ...
        async _handle(t, s) {
            ...
            try {
                ...
                if (r = await Promise.race(e), !r) throw new Error("Timed out the network response after " + this.Rt + " seconds.")
            } catch (t) {
                t instanceof Error && (n = t)
            }
            if (!r) throw new e.WorkboxError("no-response", {
    ...
    }, t.Strategy = w, t.StrategyHandler = l, t
