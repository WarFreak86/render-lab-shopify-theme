...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [5003], {
        45003: (t, e, i) => {
            ...
            function o(t, e, i) {
                var s;
                return (e = "symbol" == typeof(s = function(t, e) {
                ...
                }(e, "string")) ? s : String(s)) in t ? Object.defineProperty(t, e, {
                    value: i,
                    enumerable: !0,
                    configurable: !0,
                    writable: !0
            ...
            class E {
                ...
                compute(t) {
                    ...
                    if (t && (e.event = t, i.preventDefault && t.cancelable && e.event.preventDefault(), e.type = t.type, n.touches = this.ctrl.pointerIds.size || this.ctrl.touchIds.size, n.locked = !!document.pointerLockElement, Object.assign(n, function(t) {
                        ...
                        s.addTo(e._distance, t)
                    }
                    this.axisIntent && this.axisIntent(t);
                    let [a, h] = e._movement, [c, l] = i.threshold, {
                        _step: u,
                        values: d
                    } = e;
                    if (i.hasCustomTransform ? (!1 === u[0] && (u[0] = Math.abs(a) >= c && d[0]), !1 === u[1] && (u[1] = Math.abs(h) >= l && d[1])) : (!1 === u[0] && (u[0] = Math.abs(a) >= c && Math.sign(a) * c), !1 === u[1] && (u[1] = Math.abs(h) >= l && Math.sign(h) * l)), e.intentional = !1 !== u[0] || !1 !== u[1], !e.intentional) return;
                    let p = [0, 0];
                    if (i.hasCustomTransform) {
                        let [t, e] = d;
                        p[0] = !1 !== u[0] ? t - u[0] : 0, p[1] = !1 !== u[1] ? e - u[1] : 0
                    } else p[0] = !1 !== u[0] ? a - u[0] : 0, p[1] = !1 !== u[1] ? h - u[1] : 0;
                    this.restrictToAxis && !e._blocked && this.restrictToAxis(p);
                    let f = e.offset,
                        m = e._active && !e._blocked || e.active;
                    m && (e.first = e._active && !e.active, e.last = !e._active && e.active, e.active = n[this.ingKey] = e._active, t && (e.first && ("bounds" in i && (e._bounds = w(i.bounds, e)), this.setup && this.setup()), e.movement = p, this.computeOffset()));
                    let [v, g] = e.offset, [
                        [_, b],
                        [y, S]
                    ] = e._bounds;
                    e.overflow = [v < _ ? -1 : +(v > b), g < y ? -1 : +(g > S)], e._movementBound[0] = !!e.overflow[0] && (!1 === e._movementBound[0] ? e._movement[0] : e._movementBound[0]), e._movementBound[1] = !!e.overflow[1] && (!1 === e._movementBound[1] ? e._movement[1] : e._movementBound[1]);
                    let k = e._active && i.rubberband || [0, 0];
                    if (e.offset = function(t, [e, i], [s, n]) {
                            let [
                                [o, a],
                                [h, c]
                            ] = t;
                            return [r(e, o, a, s), r(i, h, c, n)]
                        }(e._bounds, e.offset, k), e.delta = s.sub(e.offset, f), this.computeMovement(), m && (!e.last || o > 32)) {
                        e.delta = s.sub(e.offset, f);
                        let t = e.delta.map(Math.abs);
                        s.addTo(e.distance, t), e.direction = e.delta.map(Math.sign), e._direction = e._delta.map(Math.sign), !e.first && o > 0 && (e.velocity = [t[0] / o, t[1] / o], e.timeDelta = o)
                    }
                }
                emit() {
                    let t = this.state,
            ...
            let x = t => t,
                I = {
                    ...
                    transform(t, e, i) {
                        ...
                        return this.hasCustomTransform = !!s, s || x
                    },
            ...
            class A extends T {
                ...
                pointerUp(t) {
                    ...
                    let [n, r] = e._distance;
                    if (e.tap = n <= i.tapsThreshold && r <= i.tapsThreshold, e.tap && i.filterTaps) e._force = !0;
                    else {
                        let [t, s] = e._delta, [n, r] = e._movement, [o, a] = i.swipe.velocity, [h, c] = i.swipe.distance, l = i.swipe.duration;
                        if (e.elapsedTime < l) {
                            let i = Math.abs(t / e.timeDelta),
                                l = Math.abs(s / e.timeDelta);
                            i > o && Math.abs(n) > h && (e.swipe[0] = Math.sign(t)), l > a && Math.abs(r) > c && (e.swipe[1] = Math.sign(s))
                        }
                    }
                    this.emit()
                }
                ...
                keyDown(t) {
                    ...
                    if (e) {
                        ...
                        this.start(t), i._delta = e(this.config.keyboardDisplacement, n), i._keyboardActive = !0, s.addTo(i._movement, i._delta), this.compute(t), this.emit()
                    }
                }
                keyUp(t) {
                    t.key in D && (this.state._keyboardActive = !1, this.setActive(), this.compute(t), this.emit())
                }
                bind(t) {
            ...
            function P() {
                return C && "ontouchstart" in window
            }
            let j = {
                    isBrowser: C,
                    gesture: function() {
                    ...
                    touch: P(),
                    touchscreen: P() || C && window.navigator.maxTouchPoints > 1,
                    pointer: C && "onpointerdown" in window,
                    pointerLock: C && "exitPointerLock" in window.document
                },
                K = 10,
                V = {
                    mouse: 0,
                ...
                L = h(h({}, M), {}, {
                    device(t, e, {
                        ...
                        return (this.pointerLock = s && j.pointerLock, j.touch && i) ? "touch" : this.pointerLock ? "mouse" : j.pointer && !n ? "pointer" : j.touch ? "touch" : "mouse"
                    },
                    ...
                    axisThreshold: t => t ? h(h({}, V), t) : V,
                    keyboardDisplacement: (t = K) => t
                });
            ...
            class H extends E {
                ...
                wheelChange(t) {
                    ...
                    let e = this.state;
                    e._delta = [-y(t)[1] / 100 * e.offset[0], 0], s.addTo(e._movement, e._delta), B(e), this.state.origin = [t.clientX, t.clientY], this.compute(t), this.emit()
                }
                wheelEnd() {
            ...
            let U = h(h({}, I), {}, {
                ...
                threshold(t, e, i) {
                    return this.lockDirection = "lock" === i.axis, s.toVector(t, this.lockDirection ? [.1, 3] : 0)
                },
                ...
                scrollChange(t) {
                    ...
                    let e = this.state,
                        i = function(t) {
                            ...
                            return [null != (e = null != s ? s : r) ? e : 0, null != (i = null != n ? n : o) ? i : 0]
                        }(t);
            ...
            class R extends T {
                ...
                wheelChange(t) {
                    let e = this.state;
                    e._delta = y(t), s.addTo(e._movement, e._delta), B(e), this.compute(t), this.emit()
                }
                wheelEnd() {
                    this.state._active && (this.state._active = !1, this.compute(), this.emit())
                }
            ...
            function F(t) {
                G.set(t.key, t.engine), q.set(t.key, t.resolver)
            }
            let J = {
                    key: "drag",
                    engine: A,
            ...
            let ts = {
                ...
                tn = ["target", "eventOptions", "window", "enabled", "transform"];
            ...
            class to {
                ...
                add(t, e, i, s, n) {
                    let r = this._listeners,
                        ...
                        a = h(h({}, this._gestureKey ? this._ctrl.config[this._gestureKey].eventOptions : {}), n);
                    t.addEventListener(o, s, a);
                    let l = () => {
                        t.removeEventListener(o, s, a), r.delete(l)
                    };
                    return r.add(l), l
                }
                clean() {
            ...
            class th {
                constructor(t) {
                    o(this, "gestures", new Set), o(this, "_targetEventStore", new to(this)), o(this, "gestureEventStores", {}), o(this, "gestureTimeoutStores", {}), o(this, "handlers", {}), o(this, "config", {}), o(this, "pointerIds", new Set), o(this, "touchIds", new Set), o(this, "state", {
                            shared: {
                                shiftKey: !1,
                                metaKey: !1,
                                ctrlKey: !1,
                        ...
                        function(t, e) {
                            e.drag && tc(t, "drag"), e.wheel && tc(t, "wheel"), e.scroll && tc(t, "scroll"), e.move && tc(t, "move"), e.pinch && tc(t, "pinch"), e.hover && tc(t, "hover")
                        }(this, t)
                }
                setEventIds(t) {
                    if (p(t)) return this.touchIds = new Set(Array.from(t.touches).filter(e => {
                        var i, s;
                        return e.target === t.currentTarget || (null == (i = t.currentTarget) || null == (s = i.contains) ? void 0 : s.call(i, e.target))
                ...
                bind(...t) {
                    let e, i = this.config.shared,
                        s = {};
                    if (!i.target || (e = i.target())) {
                        if (i.enabled) {
                            for (let i of this.gestures) {
                                let n = this.config[i],
                                    r = tl(s, n.eventOptions, !!e);
                                n.enabled && new(G.get(i))(this, t, i).bind(r)
                            }
                            let n = tl(s, i.eventOptions, !!e);
                            for (let e in this.nativeHandlers) n(e, "", i => this.nativeHandlers[e](h(h({}, this.state.shared), {}, {
                                event: i,
                                args: t
                            })), void 0, !0)
                        }
                        for (let t in s) s[t] = function(...t) {
                        ...
                        for (let t in s) {
                            ...
                            this._targetEventStore.add(e, i, "", s[t], {
                                capture: n,
                                passive: r
                            })
                        }
            ...
            function tc(t, e) {
                t.gestures.add(e), t.gestureEventStores[e] = new to(t, e), t.gestureTimeoutStores[e] = new ta
            }
            let tl = (t, e, i) => (s, n, r, o = {}, a = !1) => {
                    var h, d;
                    let p = null != (h = o.capture) ? h : e.capture,
                        f = null != (d = o.passive) ? d : e.passive,
                        m = a ? s : function(t, e = "", i = !1) {
                            let s = c[t],
                                n = s && s[e] || e;
                    ...
                    i && f && (m += "Passive"), t[m] = t[m] || [], t[m].push(r)
                },
                tu = /^on(Drag|Wheel|Scroll|Move|Pinch|Hover)/;

            function td(t, e, i, s, n, r) {
                if (!t.has(i) || !G.has(s)) return;
                let o = i + "Start",
                    a = i + "End";
                n[s] = t => {
                    let s;
            ...
            function tp(t, e = {}, i, s) {
                let n = ti.useMemo(() => new th(t), []);
                if (n.applyHandlers(t, s), n.applyConfig(e, i), ti.useEffect(n.effect.bind(n)), ti.useEffect(() => n.clean.bind(n), []), void 0 === e.target) return n.bind.bind(n)
            }
            ...
            function tm(t, e) {
                return ([J, $, tt, te, Z, Q].forEach(F), function(t, e) {
                    let {
                        handlers: i,
                        nativeHandlers: s,
                        config: n
                        ...
                        let [i, s, n] = function(t) {
                            let e = {},
                                i = {},
                                s = new Set;
                            for (let n in t) tu.test(n) ? (s.add(RegExp.lastMatch), i[n] = t[n]) : e[n] = t[n];
                            return [i, e, s]
                        }(t), r = {};
                        return td(n, i, "onDrag", "drag", r, e), td(n, i, "onWheel", "wheel", r, e), td(n, i, "onScroll", "scroll", r, e), td(n, i, "onPinch", "pinch", r, e), td(n, i, "onMove", "move", r, e), td(n, i, "onHover", "hover", r, e), {
                            handlers: r,
                            config: e,
                            nativeHandlers: s
                        }
                    }(t, e || {});
                    return tp(i, n, void 0, s)
                })(t, e || {})
            }
        }
    }
