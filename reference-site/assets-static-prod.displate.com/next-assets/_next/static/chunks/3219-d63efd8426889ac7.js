    ...
    [3219], {
        ...
        94093: function(e, t, n) {
            ...
            function C(e, t) {
                ...
                else if (g(e)) n = new u(e.data);
                else if (m(e)) {
                    var n, r = t ? N(e.children) : [],
                        o = new y(e.name, i({}, e.attribs), r);
            ...
            t.Element = y, t.isTag = m, t.isCDATA = b, t.isText = v, t.isComment = g, t.isDirective = x, t.isDocument = T, t.hasChildren = function(e) {
